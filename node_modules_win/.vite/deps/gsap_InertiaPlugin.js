...
*/
var gsap$1, _coreInitted$1, _toArray$1, _getUnit$1, _first, _ticker, _time1, _getCache$1, _getGSAP$1 = function _getGSAP() {
	return gsap$1 || typeof window !== "undefined" && (gsap$1 = window.gsap);
}, _lookup = {}, _round$1 = function _round(value) {
...
* @author: Jack Doyle, jack@greensock.com
*/
var gsap, _coreInitted, _parseEase, _toArray, _power3, _config, _getUnit, PropTween, _getCache, _checkPointRatio, _clamp, _processingVars, _getStyleSaver, _reverting, _getTracker = VelocityTracker.getByTarget, _getGSAP = function _getGSAP() {
...
}, _bonusValidated = 1, _isArray = Array.isArray, _emptyFunc = function _emptyFunc(p) {
	return p;
}, _bigNum = 1e10, _tinyNum = 1 / _bigNum, _checkPoint = .05, _round = function _round(value) {
	return Math.round(value * 1e4) / 1e4;
